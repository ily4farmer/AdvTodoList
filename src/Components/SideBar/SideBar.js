...
const SideBar = ({item, addItem, value , inputHandler}) => {
    ...
    return ( 
        <div className="sidebar">
            ...
            <button onClick={(e) => modalHendler(true, e)} className="sidebar__btn btn">+ Добавить папку</button>
            <div className="sidebar-form__wrapper">
                {modal && 
                    <form onSubmit={(e) => addItem(e)} action="#" className="form sidebar-form">
                        ...
                        <div className="form__list sidebar-form__list">
                            <input type="radio" className="sidebar-form__checkbox form__checkbox"/>
                            <input type="radio" className="sidebar-form__checkbox form__checkbox"/>
                            <input type="radio" className="sidebar-form__checkbox form__checkbox"/>
                            <input type="radio" className="sidebar-form__checkbox form__checkbox"/>
                            <input type="radio" className="sidebar-form__checkbox form__checkbox"/>
